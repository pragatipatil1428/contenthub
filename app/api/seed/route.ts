...
async function runSeed(prisma: PrismaClient) {
  ...
  // Create categories
  const categories = [
    { name: "Videos", slug: "videos", description: "Video content including tutorials, entertainment, and more" },
    { name: "Music", slug: "music", description: "Music tracks, albums, and audio content" },
    { name: "PDFs", slug: "pdfs", description: "PDF documents, ebooks, and guides" },
    { name: "Courses", slug: "courses", description: "Online courses and educational content" },
    { name: "Images", slug: "images", description: "Stock images, graphics, and visual content" },
    { name: "Templates", slug: "templates", description: "Website templates, design templates, and more" },
    { name: "Software", slug: "software", description: "Software applications and tools" },
    { name: "Audio", slug: "audio", description: "Podcasts, audiobooks, and audio recordings" },
  ];
